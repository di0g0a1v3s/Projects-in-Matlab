...
t = zeros(n+1,1); %inicialização do vetor que guarda os valores das abcissas
t(1) = 0;
...
for i = 1:n
    t_i = a + i*h; 
    t(i+1) = t_i; %atualização do vetor de abcissas
...
figure
plot(t(1:i+1), y(1:i+1,1));
figure
plot(t(1:i+1), y(1:i+1,2));
